...
ROOM_CAP_ORIGINAL = {402: 23, 479: 55, 482: 52, 483: 69, 502: 45, 583: 32}
ROOM_CAP = {room: max(1, int(cap * 0.70)) for room, cap in ROOM_CAP_ORIGINAL.items()}
...
RESULT_JSON_PATH = OUTPUT_DIR / "결과_서비스데이터_test70.json"
RESULT_JSON_ASCII_PATH = OUTPUT_DIR / "result_service_data_test70.json"
# 실행 제외 과목(정규화 키 기준)
